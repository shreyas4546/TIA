        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-display font-bold tracking-tight text-foreground">Tia</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="text-muted-foreground hover:text-accent-purple transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/#insights" className="text-muted-foreground hover:text-foreground transition-colors text-sm">AI Insights</Link></li>
              <li><Link to="/dashboard" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Dashboard</Link></li>
              <li><Link to="/dashboard#assistant" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Smart Assistant</Link></li>
            </ul>
          </div>
